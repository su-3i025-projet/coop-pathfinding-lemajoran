...
from method2 import Collision as cl
...
def main():
    ...
    ##Init conflict Matrix ##

    collisionHandler =  Collision(players_path)
    collisionHandler.init_collisionPointers()
    ...
    while not winner:
        ...
        for j in range(len(players)):
            ...
            if(collisionHandler.can_walk(i)):
